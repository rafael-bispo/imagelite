package br.com.estudo.imageliteapi.config.filter;

import br.com.estudo.imageliteapi.application.jwt.InvalidTokenException;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(token != null){
            try {
                ...
                log.error("Token inválid: {}", e.getMessage());
            }catch (Exception e){
    ...
    private void setUserAsAuthenticated(User user){
        ...
        //getAuthorities são roles e permissões
