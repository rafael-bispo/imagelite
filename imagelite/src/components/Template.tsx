    ...
    return(
        <>
            <Header/>
                ...
                {/* O Operador Ternário: SE loading for true ? (mostra svg) : CASO CONTRÁRIO (mostra children) */}
                {loading ? (
                    ...
                    /* Se não estiver carregando, mostra o conteúdo real da página */
                    children
...
const Loading: React.FC = () => {
        return(
            /* Adicionei flex e justify-center para o ícone ficar no meio da tela */
                    <div role="status" className="flex justify-center items-center h-32">
                        {/* Cores corrigidas para text-gray-200 e fill-indigo-600 */}
